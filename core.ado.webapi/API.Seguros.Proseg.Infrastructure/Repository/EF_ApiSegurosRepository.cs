...
{
    public class EF_ApiSegurosRepository<TEntity> : IRepository<TEntity> where TEntity : class
    {
        protected readonly ApiSegurosContext _dbContext;

        public EF_ApiSegurosRepository(ApiSegurosContext dbContext)
        {
